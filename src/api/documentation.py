...
health_example = {
    ...
    "resources": [
        {"name": "Celery.broker (RabbitMq)", "status": True},
        {"name": "Celery.backend (MongoDb)", "status": True},
        {"name": "Celery.worker (celery@e7dc920209c7)", "status": True},
        {"name": "Celery.worker (celery@CHARON)", "status": True},
...
process_example = {"status": "PENDING", "id": "94624ffb-d5e8-4fbb-a760-dbdef0abb46f"}
